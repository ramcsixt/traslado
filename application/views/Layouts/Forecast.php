		...
		<ul class="navbar-nav mr-auto">
			...
			<li class="nav-item  <?php echo $reserva?> dropdown">
				...
				<div class="dropdown-menu" aria-labelledby="navbarDropdown">
					<a class="dropdown-item <?php echo $list_reserva?> preload_page" href="<?php echo base_url("Reserva")?>"><i class="fas fa-table"></i>&nbsp;Listar</a>
					<a class="dropdown-item <?php echo $list_jsonreserva?> preload_page" href="<?php echo base_url("Reserva/Json")?>"><i class="fas fa-table"></i>&nbsp;Listar Json</a>
			...
			<li class="nav-item  <?php echo $devolucion?> dropdown">
				...
				<div class="dropdown-menu" aria-labelledby="navbarDropdown">
					<a class="dropdown-item <?php echo $list_devolucion?> preload_page" href="<?php echo base_url("Devolucion")?>"><i class="fas fa-table"></i>&nbsp;Listar</a>
					<a class="dropdown-item <?php echo $list_jsondevolucion?> preload_page" href="<?php echo base_url("Devolucion/Json")?>"><i class="fas fa-table"></i>&nbsp;Listar Json</a>
			...
			<li class="nav-item  <?php echo $flota?> dropdown">
				...
				<div class="dropdown-menu" aria-labelledby="navbarDropdown">
					<a class="dropdown-item <?php echo $list_flota?> preload_page" href="<?php echo base_url("Flota")?>"><i class="fas fa-table"></i>&nbsp;Listar</a>
					<a class="dropdown-item <?php echo $list_jsonflota?> preload_page" href="<?php echo base_url("Flota/Csv")?>"><i class="fas fa-table"></i>&nbsp;Listar CSV</a>
