<?php $this->load->view("Cliente/Login/Head") ?><br><br>
<style>
	.centrado{
		width: 360px;
		position: absolute;
...
<div class="container">
	<form action="<?php echo base_url('Cliente/Login/Verificar')?>" onsubmit="return checkSubmit();"  method="post">
		<div class="row">
...
<?php $this->load->view("Cliente/Login/Footer")?>
<!-- Modal -->
